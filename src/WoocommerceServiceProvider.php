<?php namespace aabdelhameed\Woocommerce;
...
class WoocommerceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $app->singleton('aabdelhameed\Woocommerce\WoocommerceClient', function ($app) {
            return new WoocommerceClient($app['woocommerce.client']);
        });
        $app->alias('aabdelhameed\Woocommerce\WoocommerceClient', 'woocommerce');
    }
}